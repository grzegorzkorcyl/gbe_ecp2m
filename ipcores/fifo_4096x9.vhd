...
-- Module  Version: 5.2
--/opt/lattice/ispLEVER7.2/isptools/ispfpga/bin/lin/scuba -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5m00 -type ebfifo -depth 4096 -width 9 -depth 4096 -rdata_width 9 -no_enable -pe -1 -pf -1 -e 
...
architecture Structure of fifo_4096x9 is
    ...
    attribute CSDECODE_B of pdp_ram_1_0_0 : label is "0b001";
    attribute CSDECODE_A of pdp_ram_1_0_0 : label is "0b001";
    attribute WRITEMODE_B of pdp_ram_1_0_0 : label is "NORMAL";
    attribute WRITEMODE_A of pdp_ram_1_0_0 : label is "NORMAL";
    attribute GSR of pdp_ram_1_0_0 : label is "DISABLED";
    attribute RESETMODE of pdp_ram_1_0_0 : label is "ASYNC";
    attribute REGMODE_B of pdp_ram_1_0_0 : label is "NOREG";
    attribute REGMODE_A of pdp_ram_1_0_0 : label is "NOREG";
    attribute DATA_WIDTH_B of pdp_ram_1_0_0 : label is "9";
    attribute DATA_WIDTH_A of pdp_ram_1_0_0 : label is "9";
...
begin
    ...
    pdp_ram_0_0_1: DP16KB
        ...
        port map (DIA0=>Data(0), DIA1=>Data(1), DIA2=>Data(2), 
            ...
            CLKB=>RdClock, WEB=>scuba_vlo, CSB0=>rptr_11, 
